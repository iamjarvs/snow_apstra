...
# Get blueprint information using AosClient object and blueprint name
def get_aos_blueprints(aos, blueprint_name)->Dict:
    try:
        return aos.blueprint.get_bp(bp_name=blueprint_name)
    except Exception as e:
...
def main():
    ...
    blueprint_information=get_aos_blueprints(aos=aos_obj, blueprint_name=blueprint_name)
    # Exit the module with blueprint information
    module.exit_json(blueprint_information=blueprint_information)
